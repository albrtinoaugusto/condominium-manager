...
public class HowToGUI extends javax.swing.JDialog 
{
    int xMouse;
    int yMouse;
            
    public HowToGUI(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/howto.png"))); // NOI18N
    ...
    public static void main(String args[]) 
    {
        ...
        {
            java.util.logging.Logger.getLogger(HowToGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } 
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run() 
            {
                HowToGUI dialog = new HowToGUI(new javax.swing.JFrame(), true);
