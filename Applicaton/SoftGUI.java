...
public class SoftGUI extends javax.swing.JDialog 
{
    int xMouse;
    int yMouse;
            
    public SoftGUI(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        readMore.setBorder(null);
        readMore.setBorderPainted(false);
        readMore.setContentAreaFilled(false);
        readMore.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(readMore, new org.netbeans.lib.awtextra.AbsoluteConstraints(304, 173, 126, 18));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/software.png"))); // NOI18N
    ...
    public static void main(String args[]) 
    {
        ...
        {
            java.util.logging.Logger.getLogger(SoftGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } 
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run() 
            {
                SoftGUI dialog = new SoftGUI(new javax.swing.JFrame(), true);
